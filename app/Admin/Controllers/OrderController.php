...
class OrderController extends AdminController
{
    ...
    {
        return Grid::make(new Order(['goods', 'sku', 'coupon', 'pay']), function (Grid $grid) {
    ...
    {
        return Show::make($id, new Order(['goods', 'sku', 'coupon', 'pay']), function (Show $show) {
            $show->field('id');
            $show->field('order_sn');
            $show->field('title');
            $show->field('email');
    ...
    {
        return Form::make(new Order(['goods', 'sku', 'coupon', 'pay']), function (Form $form) {
            $form->display('id');
            $form->display('order_sn');
            $form->text('title');
            $form->display('goods.gd_name', admin_trans('order.fields.goods_id'));
            $form->display('sku.sku_name', '规格');
